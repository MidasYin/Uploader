...
report_id = input("please input  Online reportId:")
...
if response.status_code == 200:
    ...
    with open(Filename, "wb") as code:
        ...
        zipWrite.close()  # 这个file是文件名，意思是直接把文件添加到zip没有文件夹层级， zipWrite.write(i)这种写法，则会出现上面路径的层级
